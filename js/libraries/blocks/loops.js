...
function dynamicOptions() {
  ...
  console.log("Inside dynamicOptions " + parent.controls_whileUntil_options);
  //Access variable from iframe's parent window. This is modified per level inside _processing.js
  var options = parent.controls_whileUntil_options;
